...
public class ModItems {
    ...
    public static final DeferredItem<Item> FOUR_MEAT_PIE = ITEMS.register("four_meat_pie", () -> new PlaceableItem(ModBlocks.FOUR_MEAT_PIE_BLOCK.get(), new Item.Properties()));
